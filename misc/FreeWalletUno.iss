; FreeWalletUno.iss
;
; Config file for creating a windows installer file for the
;
...
OutputDir=C:\Users\Choicesz\Desktop\
...
; Include all the files necessary for the the build
[Files]
Source: "C:\Users\Choicesz\Desktop\FreeWalletUno\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
